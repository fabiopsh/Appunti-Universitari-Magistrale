...
\pandocbounded{\includegraphics[keepaspectratio,alt={Pavimento flottante di un datacenter con mattonella sollevata}]{images/Tile-lifter-in-use-raised-floor-665fb3.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma hot aisle / cold aisle con contenimento del corridoio freddo}]{images/Cold-Aisle-Containment-e2b761.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Sollevamento di una piastrella dal pavimento sopraelevato (raised floor) di un data center}]{images/Tile-lifter-in-use-raised-floor-878fd6.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Connettori ottici LC (a sinistra) e SC (a destra) a confronto}]{images/Lc-sc-fiber-connectors-d94aa0.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Connettore RJ45 Ethernet}]{images/Ethernet-RJ45-connector-p1160054-3256e0.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Traffico nord-sud nell'architettura 3-tier}]{images/three-tier-architecture-traffic-5d3d84.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Inefficienze della 3-tier con traffico est-ovest}]{images/three-tier-inefficiencies-a922f0.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={STP blocca i link ridondanti nella topologia 3-tier}]{images/three-tier-spanning-tree-fa1cb3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Architettura spine-and-leaf}]{images/leaf-spine-architecture-919c04.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Architettura SDN: separazione tra application layer, control plane e data plane (infrastructure layer)}]{images/Software-defined-networking-SDN-architecture-source-Open-Networking-Foundation-ONF1-36c6af.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={SONiC --- architettura ad alto livello con componenti containerizzati}]{images/TAHKyAT-6370ad.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Formato del frame Ethernet con tag 802.1Q VLAN}]{images/Ethernet-802-1Q-Insert-864c1f.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Topologia Full Fat Tree: albero non-bloccante con uplink uguale alla somma dei downlink}]{images/Fat-tree-92c71e.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Interno di un Hard Disk Drive: piatti magnetici e testine di lettura/scrittura}]{images/Seagate-ST33232A-hard-disk-inner-view-3421b8.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={SSD NVMe M.2 2280 da 1 TB}]{images/1TB-2280-NVME-SSD-3504e0.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-01.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Modulo SSD M.2 --- il form factor ruler dei laptop}]{images/SSD-M-2-8e6d73.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-02.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-03.png}}
\emph{Fig. --- Architettura SAN: i server accedono allo storage tramite
fabric dedicato verso controller ridondanti.}

\pandocbounded{\includegraphics[keepaspectratio,alt={Schema di un'architettura SAN reale}]{images/Sch-ma-SAN-193f9c.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-04.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-05.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-06.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-07.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-08.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-11-storage-architetture-e-servizi-09.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-12-storage-avanzato-e-introduzione-al-compute-01.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-12-storage-avanzato-e-introduzione-al-compute-02.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-12-storage-avanzato-e-introduzione-al-compute-03.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-13-architettura-compute-cpu-gpu-e-npu-01.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-13-architettura-compute-cpu-gpu-e-npu-02.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-13-architettura-compute-cpu-gpu-e-npu-03.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Topologia ad anello --- schema di una rete Token Ring}]{images/Ring-topology-22c5bb.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-13-architettura-compute-cpu-gpu-e-npu-04.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-01.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-02.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Chassis HPE BladeSystem c7000 con lame inserite}]{images/HP-BladeSystem-c7000-Enclosure-4a45b3.jpg}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-03.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-04.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-05.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-06.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-14-server-bmc-e-containerizzazione-07.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-15-virtualizzazione-01.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-15-virtualizzazione-02.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-16-virtualizzazione-2-live-migration-e-gestione-01.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-16-virtualizzazione-2-live-migration-e-gestione-02.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-16-virtualizzazione-2-live-migration-e-gestione-03.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-16-virtualizzazione-2-live-migration-e-gestione-04.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-16-virtualizzazione-2-live-migration-e-gestione-05.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-nist-definition.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-iaas-stack.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-paas-stack.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-saas-stack.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-hybrid-model.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-reference-model.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-cloud-governance-models.png}}
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-18-control-layer-orchestrazione-e-sla-01.png}}
...
\chapter{Business Continuity e Security nel
Cloud}\label{business-continuity-e-security-nel-cloud}

Questa lezione tratta due funzioni \emph{cross-cutting} del modello di
riferimento cloud: la \textbf{business continuity} e la
\textbf{security}. Entrambe permeano tutti i livelli dello stack, dal
compute allo storage, dalla rete alle applicazioni. La lezione introduce
anche una breve panoramica sulla \textbf{gestione del portfolio di
servizi} cloud.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Business Continuity}\label{business-continuity}

\subsection{Cosa significa e perché è
critica}\label{cosa-significa-e-perchuxe9-uxe8-critica}

La \textbf{business continuity} (\emph{BC}) è l'insieme delle pratiche
che permettono di prepararsi, rispondere e recuperare da un'interruzione
del servizio che impatta negativamente le operazioni. In parole povere:
qualcuno ti sta pagando per un servizio, e se il servizio cade, quella
persona ha un problema.

Il concetto chiave è che nei datacenter di scala cloud i guasti sono
\emph{fisiologici}, non eccezioni. Un singolo disco ha una probabilità
di rottura di, diciamo, 1 su 10.000 per giorno. Se hai 10.000 dischi,
statisticamente uno si rompe ogni giorno. La sfida non è eliminare i
guasti, ma \textbf{rilevare il problema, confinarne l'impatto e
ripristinare il servizio} senza che l'utente se ne accorga.

\begin{calloutwarning}{L’outage è quasi imperdonabile nel cloud}

Il professore ha citato l'outage di Netflix di circa 14 anni fa, causato
dall'abbattimento di un datacenter nel New Jersey per un tornado.
Netflix non era in controllo della situazione. Nel cloud, come per la
perdita di dati nello storage, un'interruzione prolungata è considerata
gravissima: si perdono ricavi diretti, si devono rimborsare i clienti
(tipicamente con credito, non contante), e soprattutto si rischia la
reputazione.

\end{calloutwarning}

\subsection{Disponibilità del
servizio}\label{disponibilituxe0-del-servizio}
...
L'obiettivo minimo del mercato è il \textbf{4×9} (99,99\%), pari a circa
52 minuti di downtime all'anno. I contratti cloud contengono spesso una
clausola di \emph{scheduled downtime} che non viene conteggiata come
downtime effettivo: nella pratica, provider come Microsoft Azure non
dichiarano quasi mai manutenzioni programmate, ma si riservano
legalmente questa possibilità.

\begin{calloutnote}{Il mercato cloud come meccanismo di pressione}

Poiché la maggior parte delle aziende usa il cloud come IaaS, il
\emph{switchover} verso un altro provider è tecnicamente possibile.
Questo crea una pressione competitiva che incentiva i provider a
mantenere altissimi livelli di disponibilità.

\end{calloutnote}

\subsection{Cause di indisponibilità}\label{cause-di-indisponibilituxe0}

\begin{itemize}
\tightlist
\item
  \textbf{Guasto hardware} (componenti CPU, storage, rete)
\item
  \textbf{Bug software} nelle applicazioni
\item
  \textbf{Perdita di dati}
\item
  \textbf{Failure di servizi dipendenti}
\item
  \textbf{Datacenter o sito completamente offline} (per eventi estremi:
  es. un drone che colpisce un datacenter negli Emirati Arabi Uniti)
\item
  \textbf{Refresh dell'infrastruttura IT}
\end{itemize}

Il \emph{root cause analysis} in queste condizioni è complicato, perché
il sistema è distribuito e i guasti si propagano.

\subsection{Tecniche per ottenere
resilienza}\label{tecniche-per-ottenere-resilienza}

Le tecniche principali si articolano su più livelli:

\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-19-business-continuity-e-security-01.png}}
\emph{Fig. --- Le quattro direttrici della resilienza nel cloud.}

\begin{callouttip}{Ridondanza ≠ sostituto del backup}

Un sistema ridondante che funziona può comunque corrompere i dati. La
ridondanza protegge dalla \emph{indisponibilità}, il backup dalla
\emph{corruzione o perdita dei dati}. Le due cose vanno usate insieme.

\end{callouttip}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Fault Tolerance: Ridondanza e Single Points of
Failure}\label{fault-tolerance-ridondanza-e-single-points-of-failure}

\subsection{Single Point of Failure}\label{single-point-of-failure}

\begin{calloutdefinition}{Single Point of Failure (SPOF)}

Qualsiasi singolo componente la cui failure rende l'intero sistema o
servizio non disponibile.

\end{calloutdefinition}

Lo SPOF può esistere a livello di componente (CPU, disco, scheda di
rete) ma anche a livello di rack o di datacenter. Se replico due server
ma li metto nello stesso rack, il \emph{rack} stesso diventa uno SPOF:
un guasto al PDU (\emph{Power Distribution Unit}) del rack abbatte
entrambi i server.

La soluzione logica è distribuire le istanze ridondanti in \textbf{rack
diversi}, in \textbf{zone diverse} o in \textbf{datacenter diversi}.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-spof.png}}
\emph{Fig. --- Single Point of Failure a livello di componente, rack e
datacenter.}

\subsection{Compute Clustering}\label{compute-clustering}

\begin{calloutdefinition}{Compute Clustering}

Tecnica in cui due o più server (nodi) lavorano insieme e vengono
presentati come un singolo sistema, offrendo high availability e load
balancing.

\end{calloutdefinition}

Sia Linux che Windows supportano il clustering. Il software di
clustering distribuisce automaticamente i servizi tra i nodi e, in caso
di guasto di un nodo, rialloca le risorse sugli altri. Nella
virtualizzazione, l'\textbf{hypervisor cluster} consente di spostare le
VM tra host fisici, anche a caldo.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-hypervisor-cluster.png}}
\emph{Fig. --- Hypervisor cluster: le VM vengono distribuite tra host
fisici e migrate automaticamente in caso di guasto.}

\subsection{Active/Active vs
Active/Passive}\label{activeactive-vs-activepassive}
...
\tightlist
\item
  \textbf{Active/Passive}: uno dei due sistemi è in standby. In caso di
  guasto del sistema attivo, quello passivo prende il controllo. È più
  semplice da implementare ma spreca risorse: il sistema passivo può
  stare spento per lungo tempo, e quando serve potrebbe non avviarsi
  correttamente.
\item
  \textbf{Active/Active}: entrambi i sistemi lavorano
  contemporaneamente, servendo richieste. È più complesso da
  implementare (bisogna presentare un'identità logica unica verso
  l'esterno, coordinare lo stato), ma usa meglio le risorse e garantisce
  una degradazione graceful in caso di guasto.
\end{itemize}

\begin{callouttip}{Spine-and-Leaf e active/active}

Nelle reti spine-and-leaf discusse nelle lezioni precedenti, LACP
(\emph{Link Aggregation Control Protocol}) permette di avere due link
fisici verso due switch distinti che si comportano come un unico link
logico. Se un link cade, si degrada la banda ma il traffico continua.
Questo è active/active. Con lo Spanning Tree, invece, si avrebbe un link
attivo e uno bloccato (active/passive).

\end{callouttip}

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-link-switch-aggregation.png}}
\emph{Fig. --- Link e switch aggregation in topologia spine-and-leaf con
LACP.}

\subsection{NIC Teaming e
Multipathing}\label{nic-teaming-e-multipathing}

\textbf{NIC Teaming} (\emph{NIC teaming}) applica lo stesso principio al
livello della scheda di rete: più NIC fisiche vengono aggregate in una
singola NIC logica vista dal sistema operativo o dall'hypervisor. Se una
NIC fallisce, il traffico continua sulle altre.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-nic-teaming.png}}
\emph{Fig. --- NIC Teaming: più schede di rete fisiche aggregate in
un'unica interfaccia logica.}

\textbf{Multipathing} nello storage: il sistema definisce più percorsi
fisici verso una LUN (\emph{Logical Unit Number}). Lo storage bilancia
il carico su tutti i percorsi e, in caso di guasto di uno, il traffico
I/O viene reindirizzato automaticamente.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-multipathing.png}}
\emph{Fig. --- Multipathing: percorsi I/O ridondanti verso la stessa LUN
storage.}

\subsection{In-Service Software Upgrade
(ISSU)}\label{in-service-software-upgrade-issu}

\begin{calloutdefinition}{In-Service Software Upgrade (ISSU)}

Tecnica che consente di aggiornare il software su dispositivi di rete
(switch, router) senza interrompere la disponibilità della rete.

\end{calloutdefinition}

Funziona perché i dispositivi di rete di fascia alta hanno componenti di
controllo ridondanti (\emph{supervisor} o \emph{routing engine}). Si
aggiorna il software su un motore mentre l'altro mantiene la rete
operativa. Lo stesso principio vale nel datacenter: avendo tre linee di
alimentazione verso ogni rack, è possibile togliere una linea alla volta
per manutenzione senza mai abbassare il rack.

\subsection{RAID, Erasure Coding e LUN
Mirroring}\label{raid-erasure-coding-e-lun-mirroring}

\begin{itemize}
\tightlist
\item
  \textbf{RAID} (\emph{Redundant Array of Independent Disks}):
  distribuisce dati e parità su più dischi, proteggendo dalla perdita di
  uno o più dischi a seconda del livello RAID.
\item
  \textbf{Dynamic disk sparing}: sostituzione automatica di un disco
  guasto con un disco spare.
\item
  \textbf{Erasure coding}: tecnica matematica che divide un set di
  \emph{n} dischi in \emph{m} dischi dati e \emph{k} dischi di coding.
  Permette di tollerare guasti multipli con un overhead di spazio
  ottimale rispetto al RAID.
\item
  \textbf{Mirrored LUN}: una LUN viene replicata su due sistemi storage
  distinti, offrendo resilienza equivalente al RAID-1 a livello di array
  logico.
\end{itemize}

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-erasure-coding.png}}
\emph{Fig. --- Erasure coding: distribuzione di dati e simboli di
ridondanza su più dischi.}

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-mirrored-lun.png}}
\emph{Fig. --- Mirrored LUN: replica dello storage a livello di array
logico su siti distinti.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Availability Zones}\label{availability-zones}

Per eliminare gli SPOF a livello di datacenter o di rack, si usano le
\textbf{zone di disponibilità} (\emph{Availability Zones}).

\begin{calloutdefinition}{Service Availability Zone}

Una zona di disponibilità è una porzione del datacenter (o un intero
datacenter) con un proprio insieme di risorse, isolata fisicamente e
logicamente dalle altre zone. Le zone di una stessa regione sono
collegate tramite rete a bassa latenza.

\end{calloutdefinition}

Il ragionamento è: se ho due istanze dello stesso servizio, le posiziono
in zone diverse --- parte in una zona di un datacenter, parte in
un'altra zona o in un datacenter separato. Il failover tra zone può
essere configurato in modalità \textbf{active/passive} o
\textbf{active/active}.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-zone-active-passive.png}}
\emph{Fig. --- Configurazione active/passive tra zone di disponibilità:
la zona secondaria è in standby.}

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-zone-active-active.png}}
\emph{Fig. --- Configurazione active/active tra zone: entrambe le zone
servono richieste simultaneamente.}

\subsection{Failover tra zone: replicazione vs.~service
failover}\label{failover-tra-zone-replicazione-vs.-service-failover}
...
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Service failover}: quando una zona cade, il servizio viene
  riavviato (\emph{reboot}) su una nuova zona. C'è una breve
  interruzione. È più semplice.
\item
  \textbf{Replicazione della VM}: la VM viene replicata continuamente
  sull'altra zona (es. ogni 30 secondi). Il processo è simile alla live
  migration: si bookkeepano i cambiamenti dello stato della VM e li si
  trasmettono. In caso di guasto, si ``riprende'' una copia che ha al
  massimo 30 secondi di ritardo --- si perde poco più dello stato
  in-memory degli ultimi 30 secondi, ma non si riavvia dall'inizio.
\end{enumerate}

La replicazione riduce drasticamente il \textbf{RTO} (\emph{Recovery
Time Objective}). Nel service failover il RTO è il tempo di riavvio del
servizio; con la replicazione è quasi nullo.

\begin{callouttip}{Differenza concettuale fondamentale}

La replicazione della VM mantiene anche lo stato transitorio (la
memoria). Il service failover riavvia il processo da zero ma da
un'immagine coerente. La scelta dipende dai requisiti di RTO e dalla
...
\section{Data Protection: Backup e
Replicazione}\label{data-protection-backup-e-replicazione}

\subsection{RPO e RTO}\label{rpo-e-rto-1}

\begin{calloutdefinition}{RPO — Recovery Point Objective}

Quanto indietro nel tempo si può tollerare di tornare in caso di
ripristino da backup. Definisce la frequenza con cui si eseguono i
backup (ogni ora, ogni giorno, ogni settimana).

\end{calloutdefinition}

\begin{calloutdefinition}{RTO — Recovery Time Objective}

Quanto tempo ci vuole per ripristinare il servizio da un backup. Dipende
dalla tecnologia usata e dalla quantità di dati da recuperare.

\end{calloutdefinition}

\subsection{Il problema tecnico del
backup}\label{il-problema-tecnico-del-backup}

Il backup è concettualmente semplice (fare una copia dei dati), ma
tecnicamente molto complesso a scala.

\begin{callouttip}{Calcolo del tempo di backup}
...
Nella pratica la rete non è mai saturata al 100\%, quindi si raggiungono
facilmente le 3--5 ore anche per backup di pochi cento TB. Per questo
molti provider grandi usano \textbf{reti separate per il backup}, in
modo che il traffico di backup non impatti la produzione.

\end{callouttip}

Si usa il \textbf{differential backup} (backup solo dei dati modificati
dall'ultimo backup) per ridurre il volume giornaliero, ma periodicamente
è necessario un \textbf{full backup}.

\subsection{Driver per ottimizzare il
backup}\label{driver-per-ottimizzare-il-backup}

\begin{itemize}
\tightlist
\item
  \textbf{Backup window}: finestra temporale disponibile (tipicamente la
  notte) --- si ha un limite di banda × ore disponibili
\item
  \textbf{Retention period}: obblighi legali a conservare i dati per un
  certo periodo. In Italia, un service provider è tenuto a conservare
  certi dati per 5 anni per le autorità giudiziarie.
\item
  \textbf{Deduplicazione}: eliminazione dei dati ridondanti prima o dopo
  il trasferimento, sia a livello di file (\emph{file-level}) sia a
  livello di blocchi (\emph{fixed-length} o \emph{variable-length
  block}). Può essere fatta \textbf{source-side} (riducendo il traffico
  di rete) o \textbf{target-side} (spostando il carico di CPU sul
  target).
\end{itemize}

\subsection{Backup target}\label{backup-target}

I principali target per i backup sono: - \textbf{Disk library}: più
veloce da accedere, costi contenuti oggi - \textbf{Tape library}: tempi
di accesso più lenti, ma lunga durata e costo per GB molto basso ---
ideale per archivi a lungo termine

\subsection{Replicazione}\label{replicazione}

\begin{calloutdefinition}{Replicazione}

Processo di creazione di una copia esatta dei dati (\emph{replica}) per
garantire la disponibilità del servizio.

\end{calloutdefinition}

La replicazione differisce dal backup: il backup conserva versioni
storiche, la replica mantiene solo lo stato corrente (o poche versioni).

\begin{itemize}
\tightlist
\item
  \textbf{Replicazione locale (snapshot)}: copia virtuale del volume a
  un dato istante (\emph{Point-In-Time}). Nello storage virtuale, uno
  snapshot crea un disco figlio (\emph{delta disk}) che traccia solo i
  blocchi modificati rispetto al disco padre.
\item
  \textbf{Replicazione remota sincrona}: la scrittura viene confermata
  al compute solo dopo che è stata replicata sul sito remoto. RPO ≈ 0,
  ma la latenza di rete aggiunge overhead significativo.
\item
  \textbf{Replicazione remota asincrona}: la scrittura viene confermata
  subito, la replica avviene in seguito. RPO finito (dipende dal lag),
  ma non rallenta il sistema. È l'approccio più comune.
\end{itemize}

\begin{callouttip}{Consistency nel caso distribuito}

La replicazione sincrona garantisce consistenza perfetta, ma se i due
siti sono distanti (alta latenza), ogni write aspetta il round-trip. Si
può accettare la \emph{eventual consistency}: si sa che alla fine i dati
saranno consistenti, ma si sviluppa il software in modo che non assuma
consistenza istantanea. Questo è il modello tipico dell'object storage
(S3, Azure Blob).

\end{callouttip}

\subsection{CDP --- Continuous Data
Protection}\label{cdp-continuous-data-protection}

\begin{calloutdefinition}{CDP}

Soluzione di replicazione avanzata che cattura in continuo ogni modifica
ai dati, permettendo di ripristinare il sistema a qualsiasi
\emph{Point-In-Time} precedente (non solo agli snapshot pianificati).

\end{calloutdefinition}

Componenti chiave: - \textbf{Journal volume}: contiene tutte le
modifiche dall'inizio della sessione di replicazione. La dimensione del
journal determina quanto lontano nel tempo si può tornare. - \textbf{CDP
appliance}: hardware/software che gestisce la replicazione locale e
remota. - \textbf{Write splitter}: intercetta le scritture al volume di
produzione e le duplica: una copia va al volume di produzione, l'altra
al journal.

\subsection{DRaaS --- Disaster Recovery as a
Service}\label{draas-disaster-recovery-as-a-service}

In modalità DRaaS, un provider cloud offre risorse per eseguire i
servizi IT del cliente in caso di disastro. In condizioni normali, i
dati del cliente vengono replicati (in modo cifrato) verso il provider.
In caso di disastro, le VM vengono istanziate sulle risorse del provider
a partire dallo storage replicato.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-bc-cdp-operations.png}}
\emph{Fig. --- CDP Operations: replicazione locale e remota tramite
write splitter e journal volume.}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Application Resiliency}\label{application-resiliency}

Anche se l'infrastruttura è resiliente, un'applicazione mal progettata
può essere un SPOF. Il professore ha sottolineato che la resilienza va
progettata anche nel software.

\subsection{Graceful Degradation}\label{graceful-degradation}

L'applicazione mantiene funzionalità limitate anche quando alcuni moduli
o servizi dipendenti non sono disponibili. Il sistema non crolla tutto,
degrada in modo controllato. Esempio: un sito e-commerce continua ad
accettare ordini anche se il payment gateway è irraggiungibile,
processandoli quando il gateway torna disponibile.

\subsection{Retry Logic}\label{retry-logic}

Se un'operazione fallisce a causa di un errore transiente, invece di
crashare l'applicazione, si aspetta qualche secondo e si riprova. Una
strategia di retry deve definire un numero massimo di tentativi prima di
dichiarare il servizio non recuperabile. Un retry riuscito è trasparente
all'utente.

\subsection{Persistent Application State
Model}\label{persistent-application-state-model}

Lo stato dell'applicazione viene salvato fuori dalla memoria (in un data
repository persistente). Se un processo crasha, un nuovo processo può
ripartire dallo stato salvato senza perdere tutto il lavoro precedente.
Il professore ha osservato che questo pattern è comune nelle
applicazioni mobile.

\subsection{Event-Driven Processing}\label{event-driven-processing}

Invece di processare le richieste in modo sincrono, le applicazioni
leggono le richieste da una queue in modo asincrono. Questo permette a
più istanze di servire le richieste e rende il sistema resiliente alla
perdita di un'istanza: le richieste non processate restano in coda e
vengono prese da un'altra istanza.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Security}\label{security}

\subsection{Perché la sicurezza nel cloud è
critica}\label{perchuxe9-la-sicurezza-nel-cloud-uxe8-critica}

L'informazione è l'asset più prezioso di un'organizzazione. Il problema
fondamentale della sicurezza nel cloud è il \textbf{trust}: i clienti
devono fidarsi che il provider rispetti i contratti e non acceda ai loro
dati. La formula del professore è:

\[\text{Trust} = \text{Visibility} + \text{Control}\]

Il provider deve dare al cliente visibilità su cosa succede ai suoi dati
e controllo su chi può accedervi.

\begin{calloutnote}{La critica ai provider cloud e il trust}

Chi critica provider come Microsoft spesso usa l'argomento ``potrebbero
leggere i nostri dati''. Il professore ribatte che senza prove concrete
non si può agire legalmente, e che questa preoccupazione si riduce
interamente al trust. La risposta tecnica è aumentare la visibilità e il
controllo.

\end{calloutnote}

\subsection{CIA --- Confidentiality, Integrity,
Availability}\label{cia-confidentiality-integrity-availability}

\begin{calloutdefinition}{CIA}

Il triplice obiettivo della information security: -
\textbf{Confidentiality}: solo gli utenti autorizzati possono accedere
ai dati - \textbf{Integrity}: i dati non possono essere modificati da
utenti non autorizzati - \textbf{Availability}: gli utenti autorizzati
hanno accesso affidabile e tempestivo alle risorse

\end{calloutdefinition}

L'availability ha assunto un peso crescente: un attacco DoS
(\emph{Denial of Service}) che rende i dati inaccessibili è ora
considerato un attacco alla sicurezza, non solo un problema di
infrastruttura. Se hai bisogno del certificato di laurea per una
selezione pubblica e il sistema universitario è down, sei in seria
difficoltà.

\subsection{AAA --- Authentication, Authorization,
Auditing}\label{aaa-authentication-authorization-auditing}
...
\tightlist
\item
  \textbf{Autenticazione}: verificare che l'utente sia chi dice di
  essere (associare un'identità digitale a una persona reale)
\item
  \textbf{Autorizzazione}: determinare cosa quell'utente può fare,
  tipicamente tramite ruoli
\item
  \textbf{Auditing}: verificare che il sistema si stia comportando
  correttamente; può essere eseguito da auditor interni o esterni
\end{itemize}
...
Approccio ``a strati'' alla sicurezza: invece di un'unica linea di
difesa, si costruiscono più strati. Se uno viene superato, il prossimo è
già in attesa. Questo rallenta l'attaccante e dà tempo per rilevare e
rispondere.

\pandocbounded{\includegraphics[keepaspectratio]{images/dcdo-sec-defense-in-depth.png}}
\emph{Fig. --- Defense-in-depth: più strati di sicurezza sovrapposti,
dal perimetro fisico fino ai dati.}

\subsection{Trusted Computing Base
(TCB)}\label{trusted-computing-base-tcb}

\begin{calloutdefinition}{TCB}

Insieme di componenti hardware e software considerati affidabili.
Vulnerabilità all'interno del TCB possono compromettere l'intero
sistema. Va protetto con particolare cura e verificato periodicamente
per garantire che non sia compromesso.

\end{calloutdefinition}

Se il TCB viene compromesso (es. un hypervisor compromesso mette a
rischio tutte le VM ospitate), si è in una situazione critica.

\subsection{Velocity of Attack}\label{velocity-of-attack}

In un ambiente cloud con migliaia di componenti omogenei, un attacco può
propagarsi a velocità elevatissima. L'omogenità e la standardizzazione
delle piattaforme amplificano l'impatto di una singola vulnerabilità. Le
contromisure richiedono meccanismi robusti di \emph{containment}.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Minacce alla Sicurezza nel
Cloud}\label{minacce-alla-sicurezza-nel-cloud}

Il professore ha elencato le principali minacce secondo CSA (\emph{Cloud
Security Alliance}) e ENISA:

\subsection{Data Leakage (Fuga di
Dati)}\label{data-leakage-fuga-di-dati}

Un attaccante ottiene accesso ai dati confidenziali del cliente. Vettori
comuni: compromissione di database di password, exploit di applicazioni
vulnerabili, cattiva segregazione del traffico, implementazione errata
della cifratura, o un insider malicious.

\textbf{Contromisure}: cifratura dei dati \emph{at rest} (su disco),
\emph{in transit} (HTTPS), e in alcuni casi anche \emph{in memory}.
Autenticazione multi-fattore. Una tecnica interessante è il \textbf{data
shredding/threading}: il file non viene mai conservato intero su un
singolo sistema ma distribuito in frammenti su più sistemi --- il
software ricompone il file sapendo dove si trovano i pezzi. Se qualcuno
ruba un disco, ha solo un frammento inutilizzabile.

\subsection{Data Loss (Perdita di
Dati)}\label{data-loss-perdita-di-dati}

Diversa dalla fuga: i dati vengono persi, non rubati. Cause:
cancellazione accidentale da parte del provider, distruzione per
disastri naturali.

\textbf{Contromisure}: backup e replicazione.

\subsection{Account Hijacking}\label{account-hijacking}

Un attaccante ottiene le credenziali di un utente e accede al suo
account.

\textbf{Contromisure}: autenticazione multi-fattore (MFA), IPSec, IDPS,
firewall.

\subsection{Insecure APIs}\label{insecure-apis}

Le API sono usate per provisioning, configurazione, monitoring e
orchestrazione. Con l'adozione massiva delle REST API, compromettere
un'API può aggirare completamente l'interfaccia utente. Le API devono
essere progettate seguendo le best practice di sicurezza, revisionate
periodicamente, e accessibili solo agli utenti autorizzati.

\subsection{Denial of Service (DoS) e Distributed DoS
(DDoS)}\label{denial-of-service-dos-e-distributed-dos-ddos}

\begin{calloutdefinition}{DDoS}

Variante distribuita del DoS: l'attaccante controlla una \emph{botnet}
(rete di computer infetti i cui proprietari non sanno di partecipare
all'attacco) e la usa per concentrare il traffico verso un target. Il
master program coordina gli agenti che lanciano l'attacco al momento
prestabilito.

\end{calloutdefinition}

La responsabilità in caso di DDoS è controversa: se il provider non ha
implementato le contromisure tecniche previste, può essere ritenuto
parzialmente responsabile; se l'attacco supera qualsiasi misura
ragionevole, la responsabilità dipende dal contratto.

\textbf{Contromisura}: imporre limiti e restrizioni al consumo di
risorse per identificare pattern anomali.

\subsection{Malicious Insiders}\label{malicious-insiders}

Un utente interno all'organizzazione usa deliberatamente il proprio
accesso per causare danni. Il professore ha citato l'esperienza diretta
con la violazione del 2022 all'università: l'ingresso nel sistema era
avvenuto dalla rete privata del laboratorio di ingegneria, suggerendo un
possibile insider o l'exploit di una libreria (log4j) nell'intervallo
tra le due ondate di patch.

\textbf{Contromisure}: strict access control, auditing, cifratura,
disabilitazione immediata degli account dopo la separazione, RBAC,
background check.

\subsection{Abuse of Cloud Services}\label{abuse-of-cloud-services}

Le risorse cloud vengono usate per attività non autorizzate (es.
installazione di un miner di Bitcoin dopo aver compromesso il sistema).

\textbf{Contromisura}: difficile da mitigare solo con strumenti tecnici;
necessari contratti con clausole esplicite sull'uso accettabile.

\subsection{Shared Technology
Vulnerabilities}\label{shared-technology-vulnerabilities}

In ambienti multi-tenant, le vulnerabilità degli strumenti di isolamento
possono permettere a un tenant di compromettere un altro. Esempio
classico: \emph{hyperjacking} --- installazione di un hypervisor
canaglia che prende il controllo del sistema fisico.

\textbf{Contromisura}: proteggere i componenti del TCB.

\subsection{Loss of Governance e
Compliance}\label{loss-of-governance-e-compliance}

Quando si esternalizza, si tende a perdere il controllo
(\emph{governance}) su come i servizi vengono gestiti. La catena di
outsourcing (provider → sub-provider → sub-sub-provider) rende difficile
verificare il rispetto dei propri requisiti di sicurezza e compliance.

Riguardo alla \textbf{compliance}, il professore ha ricordato il
crescente peso normativo in 10 anni: GDPR (2016), misure minime di
sicurezza per la PA italiana (2017), AI Act, eIDAS2, NIS2 (recepito come
legge italiana 138/2024 in piena applicazione da ottobre 2025). I
tecnici IT stanno diventando sempre più simili agli ingegneri civili:
devono conoscere i vincoli legali oltre a quelli tecnici.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Meccanismi di Sicurezza}\label{meccanismi-di-sicurezza}

\subsection{Physical Security}\label{physical-security}

La sicurezza fisica è la base di tutto. Accesso biometrico, badge, CCTV,
sensori di movimento e fumo, 24/7 security onsite. Avere accesso fisico
ai server rende molto più probabile una compromissione.

\subsection{Identity and Access Management
(IAM)}\label{identity-and-access-management-iam}

Il professore ha menzionato OAuth, Kerberos, CHAP, OpenID, multi-factor
authentication. Il punto sull'MFA: con un secondo fattore è molto più
difficile hijackare un'identità.

\begin{calloutnote}{Kerberos e Active Directory}

Kerberos è ancora estremamente rilevante perché è il protocollo
sottostante a \textbf{Active Directory} di Microsoft, il directory
service più diffuso al mondo. Active Directory gestisce utenti, risorse,
computer e storage nelle reti aziendali.
...
Si assegnano ruoli agli utenti, non permessi diretti. Ogni ruolo ha solo
i privilegi necessari per le proprie mansioni (\emph{principio del
minimo privilegio}). La \emph{separation of duties} garantisce che
nessun individuo possa sia specificare un'azione sia eseguirla.

\subsection{Next-Generation Firewalls}\label{next-generation-firewalls}

I firewall moderni operano a \textbf{livello 7} (strato applicativo del
modello OSI). Non si limitano a filtrare per IP/porta (livello 4), ma
ricostruiscono il flusso completo dei dati e prendono decisioni basate
sul contenuto. All'università di Pisa sono in uso oltre 50 firewall che
proteggono segmenti diversi della rete con policy differenziate.

\begin{calloutnote}{DMZ: un concetto datato}

La \emph{Demilitarized Zone} (DMZ) --- la classica architettura con un
segmento ``semi-pubblico'' tra internet e la rete interna --- è
considerata obsoleta. Il professore ha accennato a un approccio più
moderno: la \textbf{Zero Trust Architecture}.

\end{calloutnote}

\subsection{IDPS --- Intrusion Detection and Prevention
System}\label{idps-intrusion-detection-and-prevention-system}

Due tecniche di rilevamento: - \textbf{Signature-based}: confronta il
traffico con un database di firme di attacchi noti. Efficace solo per
minacce conosciute. - \textbf{Anomaly-based}: analizza statisticamente
gli eventi e segnala deviazioni dalla norma (es. troppi login falliti,
consumo anomalo di banda).

\subsection{VPN, VLAN, VSAN e Zoning}\label{vpn-vlan-vsan-e-zoning}

Strumenti per isolare il traffico su infrastruttura condivisa,
garantendo la separazione tra tenant. La \textbf{zoning} nel fabric SAN
aggiunge un ulteriore livello di sicurezza: i nodi possono comunicare
solo con i nodi nella stessa zona.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Zero Trust Architecture
(ZTA)}\label{zero-trust-architecture-zta}

Il vecchio modello di sicurezza assumeva: ``tutto dentro la rete
aziendale è sicuro, tutto fuori è pericoloso.'' Non funziona più per due
ragioni: 1. I dispositivi BYOD (\emph{Bring Your Own Device}) portano
nella rete aziendale device potenzialmente compromessi 2. Le risorse
aziendali sono ormai distribuite tra on-premise e cloud multipli

Il \textbf{NIST} (\emph{National Institute of Standards and Technology})
ha formalizzato un nuovo approccio con 7 principi fondamentali.

\begin{calloutdefinition}{Zero Trust Architecture}

Modello di sicurezza in cui nessuna risorsa, nessun utente e nessuna
connessione è considerata intrinsecamente attendibile, indipendentemente
dalla posizione nella rete. Ogni accesso richiede autenticazione e
autorizzazione esplicita.

\end{calloutdefinition}

\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-19-business-continuity-e-security-02.png}}
\emph{Fig. --- Schema ZTA: il Policy Enforcement Point decide se
consentire o bloccare l'accesso alla risorsa, in base alle decisioni del
Policy Engine alimentato dal contesto.}

\subsection{I 7 principi ZTA (secondo
NIST)}\label{i-7-principi-zta-secondo-nist}

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\item
  \textbf{Tutto è una risorsa}: dati, sistemi, applicazioni, servizi ---
  tutto viene trattato come risorsa da proteggere, non solo i dati.
\item
  \textbf{Tutte le comunicazioni sono sicure indipendentemente dalla
  posizione di rete}: non esiste una zona ``safe'' nella rete. Ogni
  comunicazione è potenzialmente compromessa.
\item
  \textbf{Accesso per sessione}: l'accesso a una risorsa viene concesso
  per una specifica sessione, non in modo permanente. A ogni nuova
  sessione si ri-autentica e ri-autorizza.
\item
  \textbf{Policy dinamica}: l'accesso dipende non solo dall'identità, ma
  dallo stato osservabile del client: versione del SO, comportamento
  recente, orario, tipo di device. Esempio: un sistema Windows 7 (non
  più patchato) può essere bloccato perché considerato compromesso.
\item
  \textbf{Monitoraggio continuo dell'integrità dei device}: lo stato di
  sicurezza (\emph{security posture}) di tutti i device connessi alla
  rete va monitorato costantemente.
\item
  \textbf{Autenticazione e autorizzazione dinamiche}: strettamente
  applicate prima di ogni accesso.
\item
  \textbf{Raccolta dati per migliorare la postura di sicurezza}: più
  informazioni si raccolgono sullo stato di asset, rete e comunicazioni,
  migliore è la capacità di risposta.
\end{enumerate}

\begin{callouttip}{Attributi comportamentali e ambientali}

Se un token di accesso viene usato di sera per la prima volta (anomalia
comportamentale), il sistema può bloccare l'accesso e richiedere una
verifica aggiuntiva. Il token potrebbe essere stato rubato. Questo è un
esempio di come il contesto entra nella decisione di autorizzazione.

\end{callouttip}

\subsection{Micro-segmentazione}\label{micro-segmentazione}

La ZTA porta naturalmente alla \textbf{micro-segmentazione} della rete:
molte VLAN con policy diverse invece di poche grandi zone. In questo
modo, se un segmento viene compromesso, il resto della rete è protetto
da firewall e policy. Si guadagna tempo per rilevare e contrastare la
minaccia.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{GRC --- Governance, Risk and
Compliance}\label{grc-governance-risk-and-compliance}

\begin{calloutdefinition}{GRC}

Framework che integra tre discipline: - \textbf{Governance}: determina
le policy, i ruoli e le responsabilità di un'organizzazione -
\textbf{Risk Management}: identifica, valuta e mitiga i rischi -
\textbf{Compliance}: verifica che le policy (interne ed
esterne/normative) vengano rispettate
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-19-business-continuity-e-security-03.png}}
\emph{Fig. --- Ciclo di Risk Management.}

Il punto chiave: \textbf{nessun sistema è sicuro al 100\%}. Anche la
crittografia è teoricamente attaccabile con risorse illimitate. La
domanda non è ``siamo sicuri?'' ma ``qual è la probabilità di essere
violati entro un dato intervallo di tempo, e questo livello di rischio è
accettabile per la nostra organizzazione?''.

\begin{callouttip}{Risk Assessment pratico}

Università di Pisa: è alta la probabilità che qualcuno voglia rubare i
dati d'inventario (quante sedie abbiamo)? No.~È alta la probabilità che
qualcuno voglia i dati degli studenti? Sì. Quindi si allocano risorse di
sicurezza proporzionalmente al rischio reale.

\end{callouttip}

\subsection{Auditing}\label{auditing}

L'auditing verifica che il sistema si stia comportando come previsto.
Non è semplice logging: può essere eseguito da organizzazioni esterne
che certificano la conformità. Esempio pratico: l'Università di Pisa
gestisce firme digitali ed è soggetta ad audit governativi che
verificano la conformità dell'implementazione alla normativa.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Service Portfolio Management
(cenni)}\label{service-portfolio-management-cenni}

Verso la fine della lezione, il professore ha introdotto brevemente la
gestione del portfolio di servizi, che verrà approfondita nella lezione
successiva.

Il \textbf{service management} nel cloud è profondamente diverso dall'IT
tradizionale on-premise, dove si gestiscono singoli asset in modo
ad-hoc. Nel cloud, tutto è orientato all'\textbf{automazione}: patchare
milioni di macchine, migrare VM, installare server in modo programmato.
La standardizzazione e l'omogeneità sono essenziali.

\subsection{TCO e ROI}\label{tco-e-roi}

\begin{calloutdefinition}{TCO — Total Cost of Ownership}

Somma di tutti i costi associati al possesso e all'uso di un asset nel
tempo: costo di acquisto + costi operativi ricorrenti (energia,
manutenzione, licenze, personale).

\end{calloutdefinition}

\begin{calloutdefinition}{ROI — Return on Investment}
...
Nel cloud, calcolare il TCO di un servizio è complesso perché il
servizio usa centinaia di asset condivisi. Si aggregano i costi (CAPEX +
OPEX) per servizio, si definisce un'unità, si stima il costo per unità
con un margine, e si ottiene il prezzo da applicare al cliente.

\begin{calloutwarning}{Scenario attuale: costi in aumento}

Il professore ha citato un dato concreto: nel 2016 ha acquistato 100
server per 1M€ (10k€/server) che gestivano tutti i servizi
dell'università. Oggi la stessa operazione costerebbe 7M€. L'impennata è
dovuta alla scarsità di componenti (GPU, memoria) causata
dall'esplosione dell'AI. In più, i tempi di consegna possono arrivare a
6 mesi dall'ordine, richiedendo una \textbf{capacity planning} molto
anticipata.

\end{calloutwarning}

\subsection{Supply Chain Management}\label{supply-chain-management}

La gestione della catena di fornitura è critica: bisogna negoziare
termini considerando la qualità e i costi dei fornitori, l'evoluzione
degli SLA nel tempo, e i requisiti normativi in evoluzione. È un lavoro
che richiede competenze relazionali oltre che tecniche.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\newpage

\chapter{Operations e Considerazioni
Finali}\label{operations-e-considerazioni-finali}

Questa ultima lezione chiude il percorso del corso affrontando la parte
più procedurale e operativa del cloud: la \textbf{service operations
management}, ovvero tutto ciò che avviene \emph{dopo} che
l'infrastruttura è in piedi. Se le lezioni precedenti hanno costruito i
mattoni dell'infrastruttura --- rete, storage, compute, virtualizzazione
--- questa lezione risponde alla domanda: come si \emph{gestisce} tutto
questo nel tempo?

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Service Operations
Management}\label{service-operations-management}

Una volta che il cloud è operativo, qualcuno deve essere responsabile di
mantenerlo funzionante. Questo non significa solo ``fare sì che le
macchine girino'': significa garantire che gli \textbf{SLA siano
rispettati}, che i guasti vengano identificati e risolti, che le risorse
vengano pianificate con anticipo e che ogni modifica venga tracciata. Se
un SLA non è rispettato, il provider paga --- letteralmente, sotto forma
di compensazioni o servizi gratuiti.

Le attività tipiche di operations management si possono raggruppare in
tre categorie principali:

\begin{itemize}
\tightlist
\item
  \textbf{Gestione della configurazione dell'infrastruttura}: sapere in
  ogni momento com'è configurato ogni sistema.
\item
  \textbf{Provisioning delle risorse}: allocare risorse quando vengono
  richieste, e de-provisioning quando non servono più.
\item
  \textbf{Problem resolution}: identificare e risolvere guasti, prima
  che diventino violazioni di SLA.
\end{itemize}

A queste si aggiunge il \textbf{capacity planning}: capire \emph{quante
risorse serviranno} nei prossimi mesi, in modo da avere il tempo di
approvvigionarle prima che quelle esistenti si esauriscano. Il capacity
planning si muove su un equilibrio delicato: avere troppa capacità
inutilizzata è un costo capex sprecato che peggiora il TCO; averne
troppa poca significa violare gli SLA.

\begin{calloutnote}{Processi chiave delle operations}

I processi principali che strutturano le operations di un cloud sono: -
\textbf{Monitoring}: osservare continuamente lo stato
dell'infrastruttura - \textbf{Service Asset and Configuration
Management}: inventario e tracciamento delle configurazioni -
\textbf{Change Management}: governare ogni modifica al sistema -
\textbf{Capacity Management}: pianificare le risorse nel tempo -
\textbf{Performance Management}: garantire le prestazioni promesse dagli
SLA - \textbf{Incident Management}: rispondere a eventi non pianificati
- \textbf{Problem Management}: prevenire la ricorrenza degli incidenti -
\textbf{Availability Management}: garantire la disponibilità dei servizi
- \textbf{Security Monitoring}: rilevare e tracciare anomalie di
sicurezza
...
Il monitoring è la base di tutto: senza visibilità sullo stato dei
sistemi, non si può sapere se si stanno rispettando gli obiettivi. In
un'infrastruttura moderna esistono migliaia --- a volte milioni --- di
contatori: a livello di rete, hypervisor, sistema operativo, BMC del
server. La quantità di dati è tale che non è possibile leggerli
manualmente; servono strumenti software in grado di analizzare questo
flusso e segnalare le anomalie.

Un aspetto controintuitivo, ma importante: \textbf{ogni sistema
``pulito'' genera migliaia di errori nei propri log}. I sistemi sono
progettati per tollerare molti errori prima di smettere di funzionare,
quindi la semplice presenza di warning nei log non significa che il
sistema sia compromesso. Il vero lavoro del monitoring consiste nel
distinguere tra gli allarmi che indicano un problema reale e quelli che
sono semplicemente rumore di fondo. Questo richiede \textbf{dati
storici} per identificare outlier e variazioni rispetto alla media.

Il monitoring non riguarda solo i contatori di performance. Si
distinguono almeno tre tipi:

\begin{itemize}
\tightlist
\item
  \textbf{Configuration monitoring}: rilevare errori di configurazione,
  violazioni di policy, modifiche non autorizzate. Anche solo sapere che
  \emph{qualcosa è cambiato} --- indipendentemente da chi --- è già
  un'informazione preziosa.
\item
  \textbf{Availability monitoring}: verificare che tutti i servizi siano
  raggiungibili. A livello pratico, questo significa monitorare anche i
  singoli componenti hardware: all'Università di Pisa, ad esempio, una
  persona controlla quotidianamente lo stato di tutti i dischi dei
  cluster, usando strumenti automatizzati che segnalano fallimenti o
  degradi.
\item
  \textbf{Security monitoring}: in un cloud pubblico, il target è
  particolarmente appetibile per gli attaccanti --- riuscire a
  compromettere Google, Amazon o Azure avrebbe un impatto enorme. Per
  questo il volume di tracking in un datacenter reale è molto elevato;
  anche accessi fisici alla sala macchine sono controllati con sensori
  biometrici.
\end{itemize}

\subsection{Predictive Failure}\label{predictive-failure}

Una delle funzionalità più interessanti del monitoring moderno è la
\textbf{predictive failure analysis}. I produttori come Dell integrano
nei BMC dei modelli statistici costruiti su dati di milioni di dischi:
quando un disco inizia a mostrare pattern di comportamento associati a
un imminente guasto, il BMC emette un avviso \emph{prima} che il disco
si rompa.

Questo consente un flusso operativo molto efficace: si apre un ticket di
supporto, si rimuove il disco dal pool di storage (riducendo
temporaneamente la ridondanza ma senza perdere dati), si sostituisce il
disco e si reinserisce nel pool. Dal punto di vista dell'utente, non è
successo nulla.

\begin{calloutwarning}{Attenzione al clock della ridondanza}

Quando un componente guasto viene rilevato --- che sia per predictive
failure o per guasto improvviso --- il \textbf{clock comincia a
ticchettare}. La ridondanza è stata ridotta; se un secondo componente
guasta prima che il primo venga sostituito, il sistema può perdere dati
o servizi. La sostituzione deve avvenire il più rapidamente possibile.

\end{calloutwarning}

Il rischio opposto è l'\textbf{effetto a cascata}: se un sistema
fallisce e il meccanismo di failover sposta il carico su altri nodi,
questi possono essere sovraccaricati e fallire a loro volta, scatenando
un'ondata di failure che si propaga. Un caso reale citato da Cisternino
riguarda Amazon: un sistema fallì, il carico fu automaticamente spostato
su un altro sistema che si saturò e collassò, innescando una reazione a
catena che impiegò mesi per essere risolta --- Amazon arrivò a inviare
fisicamente tecnici con dischi aggiuntivi nel datacenter, ma la velocità
con cui i sistemi consumavano lo storage era superiore alla velocità con
cui i dischi venivano inseriti.

\subsection{Frequenza di raccolta e costo del
monitoring}\label{frequenza-di-raccolta-e-costo-del-monitoring}

Il monitoring non è gratuito: ogni ciclo di calcolo dedicato a
raccogliere e analizzare metriche è un ciclo sottratto al carico utile.
Bisogna trovare un equilibrio sulla frequenza di raccolta: troppo
frequente e si è sommersi da dati; troppo raro e si perdono eventi
critici. Lo stesso vale per la granularità: non tutti i contatori hanno
la stessa utilità, e raccoglierli tutti ad alta frequenza è
economicamente insostenibile.

\subsection{Bookkeeping e
documentazione}\label{bookkeeping-e-documentazione}

In un datacenter, \textbf{la documentazione è obbligatoria}. Il
disaccoppiamento tra hardware e software (tipico della virtualizzazione)
rende difficile risalire fisicamente a dove si trova un certo
componente: non si può semplicemente ``seguire il cavo'' perché i cavi
sono raggruppati in fascette e i sistemi virtuali non hanno
un'ubicazione fisica ovvia. Se un cluster si guasta, bisogna sapere
\emph{immediatamente} quali sistemi sono coinvolti --- e questa risposta
deve venire dalla documentazione, non da un'esplorazione manuale.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Capacity Monitoring e Capacity
Management}\label{capacity-monitoring-e-capacity-management}

Il \textbf{capacity monitoring} è il processo che osserva l'utilizzo
delle risorse nel tempo. L'obiettivo è duplice: evitare che le risorse
si esauriscano (con conseguente violazione degli SLA) e evitare che
siano sovra-dimensionate (con conseguente spreco di capex e
peggioramento del TCO/ROI).

\begin{callouttip}{L’analogia con le assicurazioni}

Il capacity management ragiona come una compagnia assicurativa: si fanno
stime statistiche sul comportamento atteso, si aggiunge un margine di
sicurezza ragionevole, e si scommette che non tutti useranno le risorse
al massimo contemporaneamente. L'\textbf{overbooking} --- offrire più
risorse di quelle fisicamente disponibili, contando sull'utilizzo medio
--- è una pratica consolidata. Se la scommessa è sbagliata, si paga il
prezzo.

\end{callouttip}

Un aspetto pratico del capacity monitoring è il controllo dell'utilizzo
\textbf{per singola istanza di servizio}. A volte un servizio consuma
molto più del previsto a causa di una configurazione mancante o di una
falla contrattuale sfruttata dagli utenti. Un esempio reale: Vodafone
offriva un router con SIM di backup cellulare per i casi di disservizio.
Il contratto non impediva esplicitamente di usare il cellulare come
connessione primaria; Cisternino lo usò così, e dopo pochi giorni
Vodafone lo chiamò perché il monitoring aveva rilevato un utilizzo
anomalo --- e risolse il problema installando la linea fissa
gratuitamente.
...
\tightlist
\item
  \textbf{Over-commitment della CPU}: assegnare più vCPU di quelle
  fisicamente disponibili, contando sull'utilizzo medio non simultaneo.
\item
  \textbf{Dynamic scheduling dei vCPU}: bilanciamento automatico del
  carico.
\item
  \textbf{Tiering dello storage per macchine offline}: quando una VM è
  spenta, il suo disco viene spostato su un tier più lento (meno
  costoso). Quando la VM si riavvia, lo storage viene migrato in live
  verso un tier più veloce, senza che l'utente se ne accorga --- e nel
  frattempo si è risparmiato spazio sul tier premium.
\end{itemize}

\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-20-operations-e-considerazioni-finali-01.png}}
\emph{Fig. --- Flusso tipico di capacity management per l'espansione di
uno storage pool.}
...
Il \textbf{change management} è, tra tutti i processi operativi, quello
più sottovalutato da chi si avvicina per la prima volta al mondo delle
operations. Studenti e programmatori tendono a vederlo come burocrazia
inutile; chi gestisce sistemi in produzione sa che la prima domanda
quando qualcosa si rompe è sempre: \emph{chi ha toccato qualcosa?}

Il change management ha come obiettivo principale registrare
\textbf{ogni modifica} alla configurazione di ogni sistema --- che sia
effettuata da un umano o da un agente automatizzato. Lo strumento
centrale è il \textbf{CMDB} (\emph{Configuration Management Database}),
che traccia lo stato di configurazione di tutta l'infrastruttura nel
tempo.

\begin{callouttip}{Esempio: aggiornamento di una versione di database}

Aggiornare la versione di un database in produzione è un'operazione
rischiosa: il nuovo schema potrebbe essere incompatibile, l'upgrade
potrebbe fallire a metà, il database potrebbe diventare irraggiungibile.
La procedura standard è: 1. \textbf{Snapshot} della VM che ospita il
database (costo temporaneo in I/O, ma reversibilità garantita) 2.
Portare il servizio offline 3. Eseguire l'upgrade 4. Verificare il
corretto funzionamento 5. \textbf{Se OK}: eliminare lo snapshot (tenerlo
ha un costo continuo sulle performance di I/O, perché ogni accesso al
disco richiede lookup multipli nella catena degli snapshot) 6.
\textbf{Se KO}: fare rollback dallo snapshot, ripristinare il sistema,
analizzare il problema prima del prossimo tentativo

\end{callouttip}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Incident Management e Problem
Management}\label{incident-management-e-problem-management}

La distinzione tra \textbf{incidente} e \textbf{problema} è fondamentale
nel modello ITIL che struttura le operations:

\begin{calloutdefinition}{Incidente}

Un incidente è un \textbf{evento non pianificato} che interrompe o
degrada un servizio. La gestione degli incidenti è \emph{reattiva}: si
risponde a qualcosa che è già successo.

\end{calloutdefinition}

\begin{calloutdefinition}{Problema}

Un problema è un \textbf{incidente ricorrente} --- o, più precisamente,
la causa radice sottostante a più incidenti. La gestione dei problemi è
\emph{proattiva}: si interviene per eliminare la causa e prevenire che
l'incidente si ripeta.

\end{calloutdefinition}

Il flusso di incident management segue questi passi:

\pandocbounded{\includegraphics[keepaspectratio,alt={Diagramma Mermaid}]{images/mermaid-lezione-20-operations-e-considerazioni-finali-02.png}}
\emph{Fig. --- Relazione tra incident management e problem management.}

\begin{callouttip}{Esempio: disco rotto e storage pool esaurito}

Un disco si rompe. Lo storage pool esaurisce la capacità residua perché
la ridondanza assorbiva spazio, ora non più disponibile. Una VM smette
di funzionare.

\begin{itemize}
\tightlist
\item
  \textbf{Incident management}: sostituire il disco rotto → la VM torna
  online.
\item
  \textbf{Root cause}: lo storage pool era già troppo pieno; la perdita
  di ridondanza ha consumato lo spazio rimanente.
\item
  \textbf{Problem management}: espandere il pool (aggiungere dischi o
  migrare dati su altri pool) in modo che un guasto futuro non esaurisca
  la capacità.
\end{itemize}

Sostituire il disco risolve \emph{il sintomo}, non \emph{la causa}.
Senza problem management, il prossimo guasto di un disco produrrà lo
stesso effetto.

\end{callouttip}

Un caso speciale di problem management \emph{proattivo} è la predictive
failure già descritta nel monitoring: sostituire un disco prima che si
rompa è intervenire sulla causa ancora prima che si manifesti
l'incidente.

\begin{calloutnote}{Incident vs. Problem: il punto chiave}

Incident management = \textbf{reattivo} → risolvi l'evento in corso.
Problem management = \textbf{proattivo} → rimuovi la causa radice per
evitare che si ripeta. I due flussi sono distinti ma si alimentano a
vicenda: gli incidenti alimentano il backlog dei problemi, e i problemi
risolti riducono la frequenza degli incidenti.

\end{calloutnote}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Performance Management e Quality of
Service}\label{performance-management-e-quality-of-service}

Negli SLA sono tipicamente incluse garanzie di performance (latenza,
throughput, disponibilità). Se il sistema è sovraccarico --- per
overbooking eccessivo o per un collo di bottiglia non previsto in fase
di progettazione --- si può violare l'SLA anche senza che nulla sia
formalmente ``rotto''.

Il performance management richiede di monitorare non solo i parametri di
availability ma anche la bandwidth allocata per le VM su ogni
hypervisor. Internamente ai datacenter moderni la rete è raramente il
collo di bottiglia (25-50 Gbps aggregati per host sono la norma), ma la
topologia di allocazione delle VM può creare situazioni in cui la
bandwidth garantita non è rispettabile.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Alerting e Reporting}\label{alerting-e-reporting}

Il sistema di \textbf{alerting} classifica i segnali su tre livelli:
informativo (nessuna azione immediata), warning (monitorare con
attenzione), fatale (servizio interrotto o SLA violato). Gli alert
fatali richiedono intervento immediato.

Il \textbf{reporting} ha invece una valenza anche non tecnica. I report
sono la documentazione che permette di: - Dimostrare al management che
un taglio di budget ha causato una violazione di SLA (\emph{``vi avevo
chiesto 5 milioni per lo storage, mi avete dato 4 milioni, ora stiamo
violando gli SLA''}). - Giustificare nuove richieste di risorse con dati
storici. - Fare \textbf{showback} --- anche in contesti non-profit come
l'università, dove non si fattura per l'uso delle risorse, si mostra
comunque agli utenti quanto stanno consumando, creando consapevolezza e
incentivando un uso efficiente.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\section{Considerazioni Finali sul
Corso}\label{considerazioni-finali-sul-corso}

\subsection{Il filo del corso}\label{il-filo-del-corso}

Il corso ha seguito una traiettoria che parte dal fisico e sale verso
l'astratto:
...
\tightlist
\item
  \textbf{Fondamenta fisiche}: energia, cooling, cablaggio --- perché un
  datacenter è prima di tutto un problema di energia e dissipazione del
  calore.
\item
  \textbf{Rete}: senza rete non esistono datacenter, esistono solo
  sistemi isolati. La rete è il \emph{fondamento} del concetto stesso di
  datacenter.
\item
  \textbf{Fabric e switching}: come i dati si muovono internamente.
\item
  \textbf{Storage}: principi, tecnologie, architetture.
\item
  \textbf{Compute}: server, BMC, GPU, NPU.
\item
  \textbf{Virtualizzazione}: il cambiamento più importante degli ultimi
  30 anni nel settore --- senza virtualizzazione non esisterebbe il
  cloud.
\item
  \textbf{Cloud}: architettura di riferimento, orchestrazione, SLA,
  business continuity, security.
\item
  \textbf{Operations}: come si gestisce tutto questo nel tempo.
\end{enumerate}

\begin{callouttip}{Il principio del bilanciamento}

Un tema ricorrente è che \textbf{il sistema efficiente non è quello con
il miglior componente, ma quello bilanciato}. Una CPU potentissima
accoppiata a storage lento produce comunque un sistema lento. Il collo
di bottiglia limita sempre la prestazione complessiva. Il design di un
datacenter --- come di qualsiasi sistema informatico --- è
fondamentalmente un esercizio di bilanciamento tra componenti
eterogenei.

\end{callouttip}

\subsection{Workload divergence e AI}\label{workload-divergence-e-ai}

Intorno al 2008 i workload hanno iniziato a divergere
significativamente: i requisiti di un web server sono profondamente
diversi da quelli di un cluster per big data analytics o di
un'infrastruttura per l'AI. L'idea di acquistare hardware generico e
riutilizzarlo per qualsiasi scopo è tramontata. Oggi si progetta
hardware specifico per workload specifici.

L'AI in particolare richiede enorme quantità di memoria (per i modelli),
latenza ultra-bassa tra i nodi (per il training distribuito) e quindi
prossimità fisica dei componenti. Questo spinge verso concentrazioni di
potenza sempre maggiori in spazi sempre più ridotti --- megawatt,
gigawatt in singoli edifici --- con sfide di cooling che stanno
ridisegnando l'architettura stessa dei datacenter.

\subsection{Informazioni sull'esame}\label{informazioni-sullesame}

L'esame è orale, con prenotazione di slot via calendario. Il prof
conduce una conversazione in cui:

\begin{itemize}
\tightlist
\item
  \textbf{Verifica la comprensione dei concetti chiave}, non la
  memorizzazione meccanica dei dettagli.
\item
  \textbf{Propone problemi di architettura} da ragionare: dato un
  workload con certe caratteristiche, come si organizzano storage,
  compute e rete? Quale tipo di storage è appropriato? Quanti nodi?
\item
  \textbf{Valuta la capacità di identificare soluzioni errate}: non
  esiste la soluzione ottimale, ma esistono soluzioni sbagliate --- e il
  corso ha fornito gli strumenti per riconoscerle.
\end{itemize}

\begin{callouttip}{Esempio di domanda d’esame (CERN)}

\emph{Al CERN viene prodotto un flusso aggregato di 10 TB/s di dati dal
rivelatore. Solo il 10\% degli eventi è ``interessante'' e deve essere
conservato; il 90\% viene scartato dal livello computazionale. Come
organizzereste storage, compute e rete? Usereste SAN o NAS? Quanti nodi
servirebbero per il frontend? Come si dimensiona il backend?}

L'obiettivo non è dare la risposta numericamente precisa, ma ragionare
correttamente: il frontend deve gestire 10 TB/s, il backend deve
ingestire 1 TB/s, il tipo di storage dipende dal pattern di accesso, la
scelta tra SAN e NAS dipende dalla granularità degli accessi e dal tipo
di parallelismo richiesto.
